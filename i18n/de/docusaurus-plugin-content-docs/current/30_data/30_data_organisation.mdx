...
* Verwenden Sie Unterstrich (_), Bindestrich (-) oder Großbuchstaben, um Elemente im Namen zu trennen. Verwenden Sie keine Leer- oder Sonderzeichen: ?!& , * % # ; * ( ) @$ ^ ~ ' { } [ ] < >.
...
* Für die automatische Verwaltung der Versionierung, Konfliktlösung und Rückverfolgungsmöglichkeiten verwenden Sie eine geeignete Versionskontrollsoftware wie [Git](https://git-scm.com/), die z. B. von [GitHub](https://github.com/) oder Ihrer Einrichtung bereitgestellt wird. Sehr stark mit unkomprimierten, lesbaren und vergleichbaren Dateien wie Textdateien oder csv.
