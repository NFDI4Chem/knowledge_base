...
-   erhaltene unbearbeitete Rohdateien von Messungen werden in offenen Dateiformaten in [ELN](/docs/eln) hochgeladen und direkt an den jeweiligen [ELN](/docs/eln)-Eintrag des Experiments angehängt, einschließlich Metadaten mit Daten zum Instrument (z. B.
-   Temperatur oder Lösungsmittel der Messung, folgen gängigen [Metadaten-Standards](/docs/metadata)
