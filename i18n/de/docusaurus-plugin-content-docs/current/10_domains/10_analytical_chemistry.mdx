...
- Metadaten, die sich auf die erhaltenen Daten beziehen, wie z. B. Masse, Volumina oder Messlösungsmittel, müssen gemäß den [Metadatenstandards](/docs/format_standards) bereitgestellt werden.
...
- Für einen Datensatz wird von einem Repositorium (z. B. [DataCite](https://datacite.org/) für das Chemotion Repositorium) ein [dauerhafter Identifikator](/docs/pid) (z. B. DOI) generiert, der in der Zeitschriftenpublikation oder in den entsprechenden Begleitinformationen angegeben wird, um die Datenveröffentlichung mit dem Manuskript zu verknüpfen.
