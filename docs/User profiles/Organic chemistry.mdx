...
## User profile Synthetic Organic/Inorganic Chemist
...
|:------------|:-----------------|:--------|:--------|:------------|:--------------|
|NMR spectroscopy|.fid|<1-50 MB|Topspin|.jdx|~1 MB|
|Mass spectrometry|.raw|~250 MB|Proteowizard|.mzML|~250 MB|
|IR spectroscopy|.ispd|<1 MB| |.dx|<1 MB|
...
- In addition to a research article in a scientific journal, the underlying research data are published in a repository and linked to the article to realise research data management according to the [FAIR data principles](/docs/Topics%20and%20Concepts/FAIR%20data%20principles) ([Best practice examples](/Topics%20and%20Concepts/Best%20practice)).
