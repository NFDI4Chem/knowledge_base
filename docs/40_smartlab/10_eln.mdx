...
Chemotion ELN and its functions were described in various publications (see [below](#sources-and-further-information)). For users, developers, and admins, a documentation is available via the project's [website](https://www.chemotion.net/chemotionsaurus/docs/intro). Chemotion ELN is an Open Source development; the source code is available on [GitHub](https://github.com/ComPlat/chemotion_ELN).
...
- [Chemotion ELN documentation](https://www.chemotion.net/chemotionsaurus/docs/intro)
