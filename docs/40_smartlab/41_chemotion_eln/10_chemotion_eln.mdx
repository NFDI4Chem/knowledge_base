...
- Check out the [Chemotion Docs](https://chemotion.net/docs) or instructions on both the Chemotion ELN and the Chemotion Repo
...
- Atted an online [Live Demo & Q&A Session](https://www.nfdi4chem.de/event/chemotion-demo-qa-session/)
...
- Setup your chemical inventory [Inventory](https://chemotion.net/docs/eln/ui/inventory) for your group and ensure correct access to it. You can [import and export](https://chemotion.net/docs/eln/ui/inventory#import-and-export-chemicals) chemical lists, as well.
- Setup [LabIMotion templates](https://chemotion.net/docs/labimotion/design-principles) to expand customize the ELN to fit your needs. Visit a [LabIMotion Oneline Hands-on Workshop](https://www.nfdi4chem.de/event/labimotion-online-hands-on-workshop/) to familiarize yourself with this feature.
