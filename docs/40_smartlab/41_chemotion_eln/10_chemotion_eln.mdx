...
<img alt="Placeholder" src={useBaseUrl('/img/smartlab/chemotion/experiment_design.png')} width="150" align="left" vspace="0" hspace="40"/>
...
{/* Comment (Nikki):What about data processing (see data lifecycle article)? */}
