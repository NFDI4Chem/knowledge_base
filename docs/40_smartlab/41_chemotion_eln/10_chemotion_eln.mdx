...
- sharing is caring article, use table/matrix
- [converter profiles](https://chemotion.net/docs/services/chemconverter/profiles)
- [Inventory](https://chemotion.net/docs/eln/ui/inventory)? rights, connecting existing database (but no good solution)
- LabIMotion templates
    - link other workshops
- Internal process for data publication (https://chemotion.net/docs/repo/workflow/group_lead_review https://chemotion.net/docs/repo/workflow)
- Establish onboarding and offboarding policies
