...
Users have to further process such data for their specific needs, and currently no overarching specifications exist. Repositories may convert these to a specified format, e.g. [Chemotion ELN](https://www.chemotion.net/chemotionsaurus/docs/about)  will convert text and Excel files to JCAMP-DX.
