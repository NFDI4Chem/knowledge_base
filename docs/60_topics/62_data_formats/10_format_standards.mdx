...
To describe chemical structures as a simple ASCII string there is the SMILES format, which is an open standard as OpenSMILES since 2007. For more information about SMILES and its variants read the [simplified molecular-input line-entry system  (SMILES)](40_smiles.mdx) article in this knowledge base.
