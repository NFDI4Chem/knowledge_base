...
Image Attribution: Philip Strömert, Oliver Köpler, Johannes Hunold, Steffen Neumann, [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0)
...
Based on an [analysis done in Task Area 6.1](https://drive.google.com/drive/folders/1lVsDZX9Jm5XK_c0qgNs-ZnNf_sOZ-1VF) of the NFDI4Chem project, the present article provides a selection of those ontologies that seem most suitable for a FAIR RDM in chemistry.

# Ontologies suitable for a FAIR RDM in chemistry

## Graphical overview
This graphical overview shows the suitable ontologies with regard to their position in the BFO/OBO framework. 
