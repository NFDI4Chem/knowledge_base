...
More specific examples could be the title, keywords, acquisition method with a certain analytical technique, and the list continues. Metadata should be supported by controlled vocabularies (ideally [ontologies](50_ontology.mdx)), and/or [data formats](40_format_standards.mdx).
