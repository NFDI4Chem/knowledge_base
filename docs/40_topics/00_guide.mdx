...
[Data availability statements](/docs/data/data_availability_statement) are also important for publishing data, as they indicate where the data supporting the findings reported in a published article can be found.
