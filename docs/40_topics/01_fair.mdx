...
![FAIR Data](/knowledge_base/static/img/topics/FAIR_data_principles.png)
...
Many of the previous points lead to one key aspect of data sharing: data reusability. Datasets must be described in a manner that allows the user to ascertain how and under which conditions the data can be reused.
...
An important piece of information for chemical data is a [machine-readable chemical structures](70_machine-readable_chemical_structures.mdx). This should be included within the dataset and/or metadata and aids computers in finding the correct data in their queries.
...
As research data management and, as such, [data publication](../30_data/60_data_publication.mdx) becomes more and more prevalent across research areas, [best practices](60_best_practice.mdx) in the individual communities will arise. This should encompass metadata templates for proper documentation of datasets, how the data should be [organized](../30_data/30_data_organisation.mdx), which vocabularies or [ontologies](50_ontology.mdx) to use, and [file formats](40_format_standards.mdx). NFDI4Chem is working to establish [metadata and data standards](https://www.nfdi4chem.de/index.php/task-areas/) for the various communities in chemistry.

Where available, community standards and best practices should be followed when those publishing prepare their datasets and relevant metadata for publication. [Repositories](20_repositories.mdx), especially domain-specific service providers, should adhere to the standards set forth by the community by requiring files and metadata to follow format specifications.
