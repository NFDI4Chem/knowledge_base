...
<a target="_blank" href={require('./assets/mrst_template.xlsx').default}>Download this docx</a>

[.ods](./assets/mrst_template.ods), [.xlsx](./assets/mrst_template.xlsx) and [.csv](./assets/mrst_template.csv) files. These template files also take advantage of **[ontologies](/docs/topics/ontology)** to unambiguously identify terms for humans and machines. PubChem_CIDs as well as CAS_RN are easily retrieved in **[PubChem](https://pubchem.ncbi.nlm.nih.gov/)** by searching via SMILES, InChI or InChIKey.
