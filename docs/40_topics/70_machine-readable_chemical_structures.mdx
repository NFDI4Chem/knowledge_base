...
<img align="center" src={useBaseUrl('/doc/Screenshots_ChemDoodle_SMILES_InChI_InChIKey.png')} alt="ChemDoodle_SMILES_InChI_InChIKey" />
...
(ChemDraw Profession v20.1.0.11, PerkinElmer Informatics, Inc., Waltham, MA, United States, 2021.)
...
To retrieve SMILES, InChI and InChIKey in MarvinSketch select a structure, then choose Edit -> Copy As -> Daylight SMILES, InChI/RInChI or InChIKey/RInChIKey.
