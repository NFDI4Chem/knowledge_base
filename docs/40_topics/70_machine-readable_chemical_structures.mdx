...
Templates for this table are provided as [.ods](static\doc\machine-readable_supplementary_table_template.ods), [.xlsx](static\doc\machine-readable_supplementary_table_template.xlsx), and [.csv](static\doc\machine-readable_supplementary_table_template.csv) files. These template files also take advantage of **[ontologies](/docs/topics/ontology)** to unambiguously identify terms for humans and machines. PubChem_CIDs as well as CAS_RN are easily retrieved in **[PubChem](https://pubchem.ncbi.nlm.nih.gov/)** by searching via SMILES, InChI or InChIKey.
