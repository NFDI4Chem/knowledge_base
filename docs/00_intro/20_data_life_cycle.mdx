...
**New data** is created or collected in this phase, e.g. through chemical synthesis, simulations of molecules, or measurements carried out on samples. When conducting the respective experiment, make sure that you also create or record the **relevant [metadata](/docs/metadata)** that describes the data. The [documentation](/docs/data_documentation) of the created data with all further information and metadata should be recorded in an [(electronic) laboratory notebook](/docs/eln).
