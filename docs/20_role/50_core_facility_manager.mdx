...
1. Deutsche Forschungsgemeinschaft (DFG), _Guidelines for Safeguarding Good Research Practice. Code of Conduct_, September 2019, [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.3923602.svg)](https://doi.org/10.5281/zenodo.3923602) {#dfg_code}

2. See [Microsoft documentation](https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/robocopy) for `robocopy` or [manpage](https://linux.die.net/man/1/rsync) for `rsync`. {#sync}
