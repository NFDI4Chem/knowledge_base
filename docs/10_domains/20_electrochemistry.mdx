...
An [electronic lab notebook (ELN)](/docs/eln) helps in the day-to-day planning and structured documentation of experiments, while some also assist in data workflow management. For electrochemical data, ELNs must be flexible and customizable, to meet the requirements of the diverse research topics. As such, there exists to date no ELN that meets the requirements of electrochemistry alone and researchers are may choose an ELN that fits best their research scope.
