...
An [electronic lab notebook (ELN)](/docs/eln) supports day-to-day planning, structured experiment documentation, and sometimes workflow management. In this diverse field, ELNs should be flexible and customizable. Universities may provide central solutions, but research groups often choose tools that match their needs and resources. The [ELN-Finder](https://eln-finder.ulb.tu-darmstadt.de/search?f.K03=Pharmacy,equals&spc.page=1) lists options, and [choosing an ELN](/docs/choose_eln) provides further guidance:
...
Especially in imaging, large data volumes can strain local [storage](/docs/data_storage). Central storage solutions can help when combined with good research data management practices to ensure reusability and avoid inefficient data organization.
