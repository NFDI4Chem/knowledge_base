...
-	Documentation of research data and metadata is carried out preferably digitally using a suitable [ELN](/docs/topics/eln) and/or to a manual laboratory notebook in paper form.
