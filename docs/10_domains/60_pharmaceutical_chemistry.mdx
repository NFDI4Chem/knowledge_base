...
[Documentation](../30_data/40_data_documentation.mdx) of research data and [metadata](../40_topics/30_metadata.mdx) is carried out, preferably digitally, using a suitable [ELN](/docs/eln) and/or a manual laboratory notebook in paper form.
