...
### How to do it [FAIR](/docs/topics/fair)?
- [documentation of all research data](/docs/problems/data_documentation) and [metadata](/docs/topics/metadata) is carried out digitally using a suitable repository (e.g. NOMAD, ioChem-BD or a general-purpose repository) to store the input files, main log and structures files (if not included in the log)
