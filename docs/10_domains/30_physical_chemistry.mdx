...
### How to do it [FAIR](/docs/topics/fair)?
- [documentation of all research data](/docs/data/data_documentation) and [metadata](/docs/topics/metadata) is carried out digitally using a suitable repository to store the data
...
<MethodsProfileTable profile_to_show={"physical"} />
