...
- **Sample processing**
    - Preparation of the sample for analysis:
        - Direct (“non-destructive”) methods: no further treatment (e.g., pH, RFA, MALDI, direct infusion)
        - Combined methods:
...
- Planning is concluded by adding the experimental details. All [metadata](/docs/topics/metadata) is [documented](/docs/problems/data_documentation) in an [ELN](/docs/topics/eln) (e.g., [Chemotion ELN](https://www.chemotion.net/chemotionsaurus/index.html)) including references.
...
- Metadata related to the obtained data, such as mass, volumes, or solvent of measurement, have to be provided according to metadata standards, [e.g. x](/docs/topics/format_standards).
...
- In addition to a research article in a scientific journal, the underlying research data are [published](/docs/problems/data_publication) in a [repository](/docs/topics/repositories) and linked to the article to realise research data management according to the [FAIR data principles](/docs/topics/fair) ([Best practice examples](/docs/topics/best_practice)).
