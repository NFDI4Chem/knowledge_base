...
- New and reused analytical methods and research ideas are derived from previous work of the own research group, scientific literature, datasets published in [repositories](/docs/topics/repositories), and requirements of public calls for research, development and demonstration projects.
...
- Planning is concluded by adding the experimental details. All [metadata](/docs/topics/metadata) is [documented](/docs/data/data_documentation) in an [ELN](/docs/topics/eln) (e.g., [Chemotion ELN](https://www.chemotion.net/chemotionsaurus/index.html)) including references.
...
- Metadata related to the obtained data, such as mass, volumes, or solvent of measurement, have to be provided according to [metadata standards](/docs/topics/format_standards).
...
<NFDI4ChemMethods methods_to_show={["nmr_spectroscopy", "mass_spectroscopy"]} />
...
- In addition to a research article in a scientific journal, the underlying research data are [published](/docs/data/data_publication) in a [repository](/docs/topics/repositories) and linked to the article to realise research data management according to the [FAIR data principles](/docs/topics/fair) ([Best practice examples](/docs/topics/best_practice)).
...
- A [persistent identifier](/docs/topics/pid) (e.g., DOI) is generated for a dataset by a repository (e.g., [DataCite](https://datacite.org/) for the Chemotion Repository), which is given in the journal publication or corresponding supporting information to link the data publication with the manuscript.
