...
For FAIR data management, electronic lab notebooks (ELNs) are especially useful for structured documentation. The [ELN-Finder](https://eln-finder.ulb.tu-darmstadt.de/search?f.K03=Pharmacy,equals&spc.page=1) lists pharmacy-specific options, and guidance on selecting an ELN is available [here](https://knowledgebase.nfdi4chem.de/knowledge_base/docs/choose_eln/).
...
Publishing research data enables reuse by other researchers. Choosing an appropriate repository is crucial; see [Choose a Repository](https://knowledgebase.nfdi4chem.de/knowledge_base/docs/choose_repository/) for guidance.
