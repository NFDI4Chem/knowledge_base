...
These should be outlined in a [data management plan (DMP)](/docs/dmp) for each project. NFDI4Chem provides an [https://rdmo.nfdi4chem.de/](RDMO template) specifically tailored to the needs of chemists.
