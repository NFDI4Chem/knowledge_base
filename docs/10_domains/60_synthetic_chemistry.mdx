...
In synthesizing a compound, every step of an experiment, from planning and execution to documentation and product characterisation, produces research data. These include synthetic procedures, experimental conditions, and manually or digitally collected analytical data. Interpreting these data enables proof of concept, process optimisation, and upscaling.
