...
- [Documentation of research data](/docs/problems/data_documentation) and [metadata](/docs/topics/metadata) is carried out digitally using an ELN.
...
|:------------|:------------|:------------|:------------|:------------|:------------|:------------|
|NMR spectroscopy|.fid|<1-50 MB|MNova <br /> Topspin|.jdx <br /> .zip<br />|JACAMP-DX<br />NMReDATA|~1 MB|
...
- Research data are processed, [analysed](/docs/problems/data_analysis) and compared (also to data of other experiments) within the Chemotion ELN.
