...
| | Generic solution | Electronic Lab Notebook (ELN) | Laboratory Information Management System (LIMS) |
|-------|:-------:|:-------:|:-------:|
...
<BulletContainer>
	<BulletBox>
		...
		<ul>
			<li>
				Linking experimental descriptions to collected data (analogue
				and digital)
			</li>
