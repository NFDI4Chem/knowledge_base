...
Fortunately, you do not always have to install a separate instance to test ELN. The Chemotion team hosts a constantly growing number of [test installations](https://demo.chemotion.scc.kit.edu/) of various ELNs that you can try out free of charge.
