...
The data availability statement enables [linking of the manuscript](/docs/data_publication) to the corresponding FAIR dataset in research data [repositories](/docs/repositories) via  [DOIs](/docs/pid), alternatively using the repository-specific identifiers or accession numbers.

Depending on the publisher, the data availability statement may be direclty added to the manuscript submitted or is automatically added during manuscript submission via the respective publishers submission system.
