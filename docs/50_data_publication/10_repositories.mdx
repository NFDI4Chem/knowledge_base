...
A repository is constituted by a repository software and a database. Researchers transfer their data to the repository typically via a browser-based user interface, or/and the repository operators **harvest** the data from other platforms via appropriate protocols and interfaces.

Some, but not all, repositories curate and review the data before **ingestion** with regard to their content and quality, sometimes, also regarding their legal aspects (copyright, data protection, [licenses](/docs/licenses)).
