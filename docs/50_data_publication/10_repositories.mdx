...
-   the domain of the data contained (discipline-specific or generic repositories),
...
A repository consists of repository software and an underlying database. Researchers transfer their data to the repository typically via a browser-based user interface, or the repository operators **harvest** the data from other platforms via appropriate protocols and interfaces.

Some, but not all, repositories curate and review the data before **ingestion** with regard to their content and quality, sometimes also regarding legal aspects (data protection, copyright and [licences](/docs/licences)).
...
Repositories can also be certified (e.g. CoreTrustSeal). Such a certification ensures that the data is citable, preserved in the long run, and may also cover aspects of data curation and data quality.
...
-   [RDA Repository Platforms for Research Data interest group](https://www.rd-alliance.org/groups/repository-platforms-research-data/activity/)
...
-   [Was ist ein Repositorium?](https://www.forschungsdaten.info/themen/veroeffentlichen-und-archivieren/repositorien/) on Forschungsdaten.info (in German)
