...
:::info Info:
To ease the selection of a suitable research data repository for chemistry research data, NFDI4Chem provides a lists of trusted, chemistry-friendly repositories in the guide on [How to Find the Right Repository](/docs/choose_repository).
:::
