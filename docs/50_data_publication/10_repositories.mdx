...
A repository consists of a repository software and an underlying database. Researchers transfer their data to the repository typically via a browser-based user interface, or the repository operators **harvest** the data from other platforms via appropriate protocols and interfaces.

Some, but not all, repositories curate and review the data before **ingestion** with regard to their content and quality, sometimes also regarding legal aspects (data protection, copyright/[licences](/docs/licences)).
...
-   [Was ist ein Repositorium?](https://www.forschungsdaten.info/themen/veroeffentlichen-und-archivieren/repositorien/) auf Forschungsdaten.info (in German)
