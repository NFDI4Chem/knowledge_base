...
Repositories are locations where digital objects are stored and made available to the public or data users. They can be regarded as the core of research data sharing as they provide platforms to store, curate, publish, archive, preserve, and access data.
