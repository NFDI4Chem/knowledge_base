...
Having machine-readable chemical structures as [Chemical table files](https://en.wikipedia.org/wiki/Chemical_table_file), such as mol files, and as [SMILES](https://en.wikipedia.org/wiki/Simplified_Molecular_Input_Line_Entry_Systems) structure codes plus the [InChI](https://en.wikipedia.org/wiki/International_Chemical_Identifier) identifiers as part of a dataset associated with a research article will enhance its [findability](/docs/fair) by making the article easily indexable and structure searchable. This also improves [interoperability](/docs/fair) and facilitates [reuse](/docs/fair) of scientific work.
...
:::danger Notice:
Please note that there are currently limitations with [SMILES](https://en.wikipedia.org/wiki/Simplified_Molecular_Input_Line_Entry_Systems) and [InChI](https://en.wikipedia.org/wiki/International_Chemical_Identifier) for inorganic and especially organometallic compounds.
:::
