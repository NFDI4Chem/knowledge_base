...
:::danger Notice:
Please note that there are currently limitations with [SMILES](/docs/smiles) and [InChI](/docs/inchi) for inorganic and especially organometallic compounds. 
:::  
...
Information to enhance machine-readability might be provided within a dataset as a [supplementary table](https://doi.org/10.1186/s13321-021-00520-4). This table should be provided in a machine-readable text-based format such as a CSV file.

The minimum and recommended columns of such a table are as follows:
- Letter-code and number in your lab journal, i.e. a local sample identifier
- Number(s) of structures in the article, i.e. a local structure identifier within your article
- SMILES
- InChI
- InChIKey
