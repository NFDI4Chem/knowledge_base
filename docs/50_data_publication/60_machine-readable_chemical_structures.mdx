...
:::danger Notice:
Please note that there are currently limitations with [SMILES](https://en.wikipedia.org/wiki/Simplified_Molecular_Input_Line_Entry_System) and [InChI](https://en.wikipedia.org/wiki/International_Chemical_Identifier) for inorganic and especially organometallic compounds.
:::
