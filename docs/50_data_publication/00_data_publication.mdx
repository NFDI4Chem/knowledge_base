...
Publication of data is essential to ensure that findings are transparent and reproducible. Moreover, it prevents duplicate efforts to generate data, hence, data publishing is also a measure of sustainability.
...
Additionally, the research community benefits here as, for example, new research is made possible and efficiency in research increases. Also the public sector will profit by enhanced public trust in science, as data publication allows for the validation of research results. Nonetheless, the publication of data is of economic benefit if the results can be reused by the private sector.
