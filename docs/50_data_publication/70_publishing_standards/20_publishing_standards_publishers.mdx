...
As an academic publisher, promoting data sharing is essential for advancing research and ensuring that findings are accessible to the scientific community. This guide outlines key recommendations and considerations for journals. It aims to assist you in helping researchers succesfully publish the research data underlying their results reported in your journals and to ensure that this data is properly associated to the respective article.
...
Journal author guidelines should explicitly encourage pre-submission of datasets prior to manuscript submission—similar to current practices for crystallographic data published in CSD with CCDC. Early publication facilitates manuscript workflows as DOIs are registered beforehand.
