...
Once you have ensured your data is [well-organized](/docs/data_organisation) and you have chosen appropiate [data formats](/docs/format_standards), you can upload your files. Depending on the [repository you have chosen](/docs/choose_repository), it may be easiest to directly upload your data when creating the dataset. For example, [RADAR4Chem](https://radar4chem.radar-service.eu/) will automatically extract all files from a zip file at this point and replicate the directory structure, while this is not the case if the data is uploaded at a later point in time and an empty dataset is created first.
