...
While such information is not required for structured domain-specific repositories such as Chemotion Reopositoy, since this information is provided by the repository software, datasets in generic repositories benefit from this information. 
...
- local chemical structure identifier i.e. numbers of structures in the research article
- local chemical sample symbol i.e. letter-code and number in your lab journal
- SMILES
- InChI and InChIKey
