...
Publishing and therefore sharing these chemistry research data in a [FAIR](/docs/fair) manner adds value to the research results and enables discovery and reuse. For this purpose it is important to consider aspects such as rich [metadata](/docs/metadata), provenance information, information on the [license](/docs/licences) applied, [persistent identifiers](/docs/pid), [data formats](/docs/data_formats) for analytical data, and [machine-readable chemical structures](/docs/machine-readable_chemical_structures).
