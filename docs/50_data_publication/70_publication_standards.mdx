...
On this page we collect a non-exhaustive list of standards for data publication, formulated as principles, developed within the NFDI4Chem Publication Standards project. These standards are intended to streamline publication workflows, including the review process of manuscripts with corresponding datasets published in research data repositories. 
