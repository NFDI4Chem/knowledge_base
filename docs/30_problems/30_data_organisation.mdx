...
After [documentation of your research data](/docs/problems/data_documentation) there needs to follow more detailed descriptions of how your information is saved - a quick look at files and folders. For an idea about storage locations and storage methods see [Data Storage and Archiving](/docs/problems/data_storage).


## files: name conventions

Human users benefit from file names that allow easy sorting and a notion of the content at first glance. But grown expressions like the following are not helpful:
...
We need short and descriptive file names as identifier for a document. Useful names gives information what the file contains and helps in sorting them. Pay attention to your naming scheme when working with others: It is important to follow the same file naming convention, so develop an adapted scheme when the project starts and write it down including explaination of abbreviations in your [data documentation](/docs/problems/data_documentation).
...
Find a balanced set of elements: Too many make it difficult to grasp quickly, while too few elements quickly exhaust the possible namespace. Be aware of the maximum number of characters for path names.
...
A good file name like `20180211_ELI5_TEMP_BH01_RAW_03.csv` can easily be sorted by date and tells you:
...
* Use a Cloud Storage service (see [Data Storage and Archiving](/docs/problems/data_storage)) that provides automatic file versioning. Very strong on spreadsheets, text files and slides.
...
- short term and long term storage, [Data Storage and Archiving](/docs/problems/data_storage)
...
One look and everything should be intuitively understandable. The folder structure helps you navigate through the individual pieces of information. Develop a convention when the project starts and write it down including explaination of abbreviations in your [data documentation](/docs/problems/data_documentation). Try to consistently apply the same strategy in every project within the research group.
