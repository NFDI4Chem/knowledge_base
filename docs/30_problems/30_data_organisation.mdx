...
Good data organisation does not happen over night - take small steps first. The organisation of research data is primarily an organisational problem that is accompanied and supported by technological measures:
