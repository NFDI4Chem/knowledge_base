...
<KbTagCloud cloudTags={[ "Existing data", "Format", "Metadata", "Storage and backup", "Security", "Responsibility", "Intellectual property rights", "Access and sharing", "Audience", "Selection and retention periods", "Archiving and preservation", "Ethics and privacy", "Budget", "Data organization", "Quality Assurance", "Legal requirements" ]} min={20} max={35} shuffle={false} />
