...
description: description of everything that "your future-self" would need to know
page_id: data_documentation
related_pages:
	problems: [data_organisation, data_storage]
---
...
<img alt="data for future generations" src={useBaseUrl('/img/problems/data_1517.png')} width="250" align="right" vspace="10" hspace="10" />
...
An essential task is to plan the organisation and storage of data, [metadata](/docs/topics/metadata), and documents in advance and to document the relevant measures.
...
<img alt="small data handout" src={useBaseUrl('/img/problems/en_data_orgsteps.png')} width="400" align="right" vspace="10" hspace="10" />
