...
- Use a Cloud Storage service (see [Data Storage and Archiving](/docs/data_storage_daösfj)) that provides automatic file versioning. Very strong on spreadsheets, text files and slides.

## Files: types of metadata

Consider the way data and [Metadata](/docs/metadata_daödslfk/) can be stored together as FDOs (Fair Digital Objects). For example, metadata can be divided into the following four categories:
