...
import IntroButton from '@site/src/components/intro_buttons.js';
...
<IntroButton url={"/docs/domains/guide"} imgUrl={"/img/nfdi4chem_Domains.svg"} text={"Domains"} />
...
<IntroButton url={"/docs/role/guide"} imgUrl={"/img/nfdi4chem_Roles.svg"} text={"Roles"} />
...
<IntroButton url={"/docs/data/guide"} imgUrl={"/img/nfdi4chem_Handling_Data.svg"} text={"Handling Data"} />
...
<IntroButton url={"/docs/topics/guide"} imgUrl={"/img/nfdi4chem_Topics_and_Concepts.svg"} text={"Topics & Concepts"} />
...
<IntroButton url={"/docs/lead-by-example"} imgUrl={"/img/nfdi4chem_Lead_by_Example.svg"} text={"Lead by Example"} />
