...
const commonFeatures = {
	...
	smartlab: {
		...
		text: <Translate>Smartlab</Translate>,
	},
	eln: {
		url: "/docs/eln",
		imgUrl: "/img/nfdi4chem_SmartLab.svg",
	...
	dmp: {
		...
		text: <Translate>Data Management Plan</Translate>,
	},
	dataOrganisation: {
		url: "/docs/data_organisation",
		imgUrl: "/img/nfdi4chem_Data_Organisation.svg",
		text: <Translate>Data Organisation</Translate>,
	},
	dataDocumentation: {
	...
	chooseRepository: {
		...
		text: <Translate>How to choose the right repository</Translate>,
	},
	lbe: {
		url: "/docs/datasets",
