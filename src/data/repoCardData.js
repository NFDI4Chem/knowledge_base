...
export const repositoryData = [
	{
		...
		description: (
			<Translate>
				...
				analysis data such as NMR, UV-VIS, IR, and MS data.
			</Translate>
		),
	},
	{
	...
	},
	{
		...
		description: (
			<Translate>
				...
				reliable home for all chemical research data that do not fulfil
	...
	},
	{
		...
		description: (
			<Translate>
				...
				incorporates the STRENDA Guidelines for reporting enzymology
				data.
			</Translate>
		),
	},
...
export function RepoDiv(props) {
	return <div style={props.img ? imgStyle : descStyle}>{props.children}</div>;
}
